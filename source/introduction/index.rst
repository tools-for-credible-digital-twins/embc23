...
In this hands-on tutorial-style workshop, we will demonstrate a range of tools that encourage users to create, share, and publish physiological models in a reproducible and FAIR manner.
...
We will present the hands-on tutorials using stand-alone desktop or web applications and using services or programming interfaces that could be more easily integrated into existing tooling and practices in your own lab.
...
All tools and example models and data used in the workshop will be available for attendees to access and share following the workshop, along with suitable documentation to help attendees share what they have learnt with colleagues.
